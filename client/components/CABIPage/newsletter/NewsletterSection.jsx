...
export default function NewsletterSection() {
  return (
    <section className="section !pb-0 md:!pb-6 lg:!pb-[1.5rem] !px-0 md:!px-3 lg:!px-[3rem] bg-white">
      <div className="flex flex-col gap-[44.2px] px-[23.4px] py-[74px] md:rounded-[26px] bg-purple-700">
        ...
        <form className="flex flex-col items-center gap-[44.2px]">
          <div className="flex flex-col gap-[20px]">
            <div className="flex flex-col items-center gap-[13px]">
              <input
                ...
                className="w-full md:max-w-[581.1px] lg:max-w-[771px] outline-none rounded-[7.8px] p-[13px] !leading-[150%] !tracking-[0.2%] !text-[15px] text-grey-800 placeholder:text-grey-800 bg-blue-200 focus:bg-white/20 transition-all duration-300"
              />
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex items-center">
                <input
                  type="checkbox"
                  id="privacy-policy"
                  className="peer h-6 w-6 cursor-pointer appearance-none rounded-md border border-white/20 bg-white/5 transition-all checked:bg-purple-900 checked:border-purple-900"
                />
          ...
          >
            <span className="!leading-[150%] !tracking-[0.2%] !text-[15px] text-blue-300">
              Subscribe Now
            </span>

            <span className="p-[8.85px] rounded-full bg-blue-800">
