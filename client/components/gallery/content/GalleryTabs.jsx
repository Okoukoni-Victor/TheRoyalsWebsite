  ...
  return (
    <>
      ...
      <div className="flex justify-start overflow-x-auto pb-4 -mx-4 px-4 scrollbar-hide">
        <div className="inline-flex p-1.5 bg-grey-50/30 mb-6 rounded-full border border-grey-50/50 whitespace-nowrap">
      ...
      <div className="inline-flex gap-6 md:gap-10 mb-12 border-b border-grey-100 overflow-x-auto scrollbar-hide">
