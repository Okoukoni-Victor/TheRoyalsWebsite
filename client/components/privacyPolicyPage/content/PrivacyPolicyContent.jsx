...
const sections = [
  {
    title: "Introduction",
    content: (
      <p className="!leading-[150%] !text-[21px] text-grey-500">
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col gap-[69px]">
        <div>
          <h6 className="mb-[14px] !leading-[150%] !text-[19px] text-grey-400">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-[14px] !leading-[150%] !text-[19px] text-grey-400">
          We use the information collected to:
        </p>

        <ul className="list-disc list-inside space-y-2 ps-4 !leading-[150%] !text-[21px] text-grey-500">
    ...
    content: (
      <>
        <p className="mb-[14px] !leading-[150%] !text-[19px] text-grey-400">
          ...
          parties. <br /> <br /> We may share information:
        </p>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col gap-[37px]">
        <p className="!leading-[150%] !text-[19px] text-grey-400">
    ...
    content: (
      <div className="flex flex-col gap-[69px]">
        <p className="!leading-[150%] !text-[21px] text-grey-500">
          ...
          <br /> <br /> A cookie is a small data file stored on your device that
          helps us recognize your browser and improve site functionality.
        </p>
        ...
        <div>
          ...
          <p className="mt-[14px] !leading-[150%] !text-[19px] text-grey-400">
    ...
    content: (
      <>
        <p className="!leading-[150%] !text-[21px] text-grey-500">
          ...
          be posted on this page with a revised effective date. <br /> <br />{" "}
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-6 ps-4 !leading-[150%] !text-[21px] text-grey-500">
          <li>Email: hello.theroyals@gmail.com</li>
          <li>Phone: +2347010990908</li>
          <li>
            Website:{" "}
            <a href="/" target="_blank" className="text-blue-300">
              The Royals Home Page
            </a>
          </li>
          <li>
            Contact Page:{" "}
            <a href="/contact" target="_blank" className="text-blue-300">
              The Royals Contact Page
            </a>
          </li>
        </ul>
      </>
    ...
    <section className="section bg-white">
      <div className="max-w-7xl mx-auto">
        {sections.map((section) => (
          <PrivacyPolicySection key={section.title} title={section.title}>
            {section.content}
