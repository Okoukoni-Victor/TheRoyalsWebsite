...
export default function PartnersSection() {
  const partners = [
    {
      name: "CABI",
      logo: { path: "/assets/logo-cabi.png", width: 173, height: 76 },
      radius:
        "rounded-tl-[20px] rounded-tr-[20px] md:rounded-tr-none md:rounded-bl-[20px]",
    },
    {
      name: "NYSC",
      logo: { path: "/assets/logo-nysc.png", width: 90.75, height: 92.8 },
      radius: "rounded-none",
    },
    {
      name: "Ebonyi State",
      logo: { path: "/assets/logo-ebonyi.png", width: 88, height: 92 },
      radius:
